...
public class Physics2D {
    ...
    public void add(GameObject go) {
        ...
        if(rb != null && rb.getRawBody() == null) { // check if added twice to physics engine
    ...
    public static boolean checkOnGround(GameObject gameObject, float innerPlayerWidth, float height) {
        ...
        RaycastInfo info = saikaone.Window.getPhysics().raycast(gameObject,raycastBegin,raycastEnd);
...
//        DebugDraw.addLine2D(raycast2Begin, raycast2End, new Vector3f(1,0,0));
        ...
        return (info.hit && info.hitObject != null &&
                info.hitObject.getComponent(Ground.class) != null) ||
                (info2.hit && info.hitObject != null &&

...
public class GoombaAI extends Component{
    // TODO: Make common logic with PlayerController!
    ...
    private transient float timeToKill = 0.5f; //squashed animation wait-time
    ...
    public void start() {
        ...
        this.acceleration.y = Window.getPhysics().getGravity().y * 0.7f; //TODO:Make 0.7f constant for both player & enemy
    }

    @Override
    public void update(float dt) {
        //only animate when in view of Camera

...
public class Pipe extends Component{
    ...
    public boolean playerAtEntrance() {
        ...
        Vector2f min = new Vector2f(gameObject.transform.position)
                        .sub(new Vector2f(gameObject.transform.scale).mul(0.5f)); //bottom left
    ...
    public void endCollision(GameObject object, Contact contact, Vector2f hitNormal) {
        PlayerController playerController = object.getComponent(PlayerController.class);
        if(playerController != null) {
